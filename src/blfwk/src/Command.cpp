...
std::string Command::getResponse() const
{
    ...
    retVal.append("  'value': ");
    retVal.append(format_string("%d", static_cast<int32_t>(m_responseValues.at(0))));
    retVal.append(",\n");
    retVal.append("  'description': '");
    retVal.append(format_string("%d (0x%X) %s", m_responseValues.at(0), m_responseValues.at(0), getStatusMessage(m_responseValues.at(0)).c_str()));
    retVal.append("'\n],\n");
    retVal.append("'response': [ ");
    for (int i = 1; i < (int)m_responseValues.size(); ++i)
    {
        retVal.append(format_string("%02X", m_responseValues.at(i)));
        retVal.append(", ");
    }
    retVal.append("],\n");
